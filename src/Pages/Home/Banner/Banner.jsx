...
import bg from "../../../assets/images/Banner/bgg.png"
    ...
    return (
      <section className="container mx-auto">
        <div className="md:grid grid-cols-2 place-items-center">
          ...
          <div>
            <div data-aos="fade-left" className="relative first-bg flex">
              <img className="h-[508px]" src={bg} alt="" />
        ...
        <div className="md:grid grid-cols-2 gap-28 place-items-center my-10">
          ...
          <div data-aos="flip-right" className="space-y-9">
            <h2 className="font-bold text-black text-4xl">
